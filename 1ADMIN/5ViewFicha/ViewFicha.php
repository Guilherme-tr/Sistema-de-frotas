        ...
        <div class="wrapper wrapper--w960">
            <div class="card card-2">
                ...
                <div class="card-body">
                    ...
                    <?php while ($linha = mysqli_fetch_array($consulta6)){ ?>
                        ...
                        <div class="col-2-old"><b class="title">PLACA:</b>
                            ...
                            <div class="col-2-old"><b class="title">OCUPAÇÃO:</b>
                                ...
                                <div class="col-2-old"><b class="title">Km INICIAL:</b>
                                    <div class="input-group">
                                        <input class="input--style-2" type="number" placeholder="Km Inicial" name="km_inicial" value="<?php echo $linha['Km_inicial']; ?>">
                                    </div>
                                </div>
                        ...
                        <div class="col-2-old"><b class="title">DESTINO:</b></div>
                                <div class="input-group">
                                    <textarea  required class="form-control" rows='3' type="text" placeholder="Cidade" name="destino"><?php echo $linha['destino']; ?></textarea>
                                </div>
                            
                        <div class="col-2-old"><b class="title">FINALIDADE:</b></div>
                            <div class="input-group">
                                <textarea class="form-control" rows='3' type="text" placeholder="Finalidade" name="finalidade"><?php echo $linha['finalidade']; ?></textarea>
                            </div>
                        </div>
                            <?php } ?>
                            <?php } ?>
