		...
		<div class="container-table100">
			...
			<div class="row row-space">                       
				<p> &nbsp<p> <p> &nbsp<p> <p> &nbsp<p> <p> &nbsp<p> <div class="col-2-old">
						...
						<b class="title">Digite o código da Placa:</b>
						<div class="input-group mb-3">
							<input class="form-control" type="text" placeholder="aguardando..." name="placa">
				...
				<div class="input-group-append">
					<a href="./gerarplanilha2.php?placa=<?php echo $placa; ?>"><button type='button' class="btn btn-primary">Gerar Excel</button></a>
				</div></div>
				<div class="table100">
					<table>
						<thead>
						...
						<?php
							...
							$query7 = "SELECT * FROM fichacontrole WHERE placa_veiculo_fk = '$placa' ORDER BY data_saida DESC";
							$consulta7 = mysqli_query($conexao, $query7);
							while($linha = mysqli_fetch_array($consulta7)){
