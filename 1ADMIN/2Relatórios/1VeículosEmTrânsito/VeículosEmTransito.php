	 ...
	 <div class="limiter">
		 <div class="container-table100">
			 ...
			 <div class="wrap-table100">
				...
				<div class="input-group-append">
					<a href="./gerarplanilha.php?data=<?php echo $data_saida; ?>&data2=<?php echo $data_saida2; ?>"><button type='button' class="btn btn-primary">Gerar Excel</button></a>
				</div>
				</div>
				 <div class="table100">
					<table>
						...
						<?php
							...
							while($linha = mysqli_fetch_array($consulta8)){
								...
								echo '<a onclick="location.href=`./ViewFicha/ViewFicha.php?id_ficha='.$linha['id_ficha'].'`"><td class="column4">'.$data_saida.'</td>';
