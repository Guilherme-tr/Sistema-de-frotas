    ...
    <div class="page-wrapper bg-red p-t-180 p-b-100 font-robo">
        <div class="wrapper wrapper--w960">
            <div class="card card-2">	
                ...
                <div class="card-body">
                    <h2 class="title">Adicionar Manutenção</h2>
                    <br>
                        <div class="row row-space">
                        <div class="col-2-old">
                            <input hidden class="input--style-2" type="text" name="id_manutencao" >
                        </div>
                        <div class="row row-space">
                            <div class="col-2-old"><b class="title">PLACA:</b>
                                <div class="input-group">
                                    <input required class="input--style-2" type="text" placeholder="Placa" name="placa_FK"  >
                                </div>
                            </div>  
                            <div class="col-2-old"><b class="title">NÚMERO DA NOTA:</b>
                                <div class="input-group">
                                    <input required class="input--style-2" type="text" min='1' placeholder="Número da nota" name="numero_nota" >
                                </div>
                            </div>  
                            <div class="col-2-old"><b class="title">SERVIÇO:</b>
                                <div class="input-group">
                                    <input required class="input--style-2" type="text" placeholder="Serviço" name="servico"  >
                                </div>
                            </div>
                            <div class="col-2-old"><b class="title">VALOR:</b>
                                <div class="input-group">
                                    <input required class="input--style-2" type="text" placeholder="Valor" name="valor"  >
                                </div>
                            </div>
                        <div class="p-t-30">
                            <a href="processa_manutencao.php?id=<?php echo $id_manutencao; ?>"><button class="btn btn--radius btn--green" type="submit">Enviar</button></a>
                        </div>
