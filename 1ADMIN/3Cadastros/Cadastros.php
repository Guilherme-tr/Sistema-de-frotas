...
<nav class="navbar navbar-expand-custom navbar-mainbg"> 
        ...
        <a class="navbar-brand navbar-logo" href="/JBTC-FROTA/1ADMIN/1FichadeControle/FichaControle.php">FROTA</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
					<a class="nav-link" href="/JBTC-FROTA/logout.php"><i class="far fa-calendar-alt"></i>Sair</a>
                </li>
            </ul>
        </div>
    </nav>
	...
	<div class="container-login100-form-btn">
		<a href="./1- Funcionário/Funcionário.php"><button class="login100-form-btn">
			Funcionários	
		</button></a>
	</div>
	<br>
	<br>
	<div class="container-login100-form-btn">
		<a href="./2- Departamento/Departamento.php"><button class="login100-form-btn">
			Departamentos
		</button></a>
	</div>
	<br>
	<br>
	<div class="container-login100-form-btn">
		<a href="./3- Veículo/Veículo.php"><button class="login100-form-btn">
			Veículos
		</button></a>
	</div>
	<br>
	<br>
	<div class="container-login100-form-btn">
		<a href="./4- Usuário/Usuário.php"><button class="login100-form-btn">
			Usuário	
		</button></a>
	</div>
