    ...
    <div class="page-wrapper bg-red p-t-180 p-b-100 font-robo">
        <div class="wrapper wrapper--w960">
            <div class="card card-2">	
                ...
                <div class="card-body">
                    <h2 class="title">Resumo Funcionário</h2>
                    <br>
                    <form method="POST" action='./Edita_funcionario.php'>
                    <?php while ($linha = mysqli_fetch_array($consulta2)){ ?>
                        <?php if ($linha['id'] == $id){ ?>
                        <div class="col-2-old">
                            <input hidden class="input--style-2" type="text" name="id" value="<?php echo $linha['id']; ?>">
                        </div>
                        <div class="row row-space">
                            <div class="col-2-old"><b class="title">NOME DO FUNCIONÁRIO:</b>
                                <div class="input-group">
                                    <input required class="input--style-2" type="text" placeholder="Nome" name="nome_funcionario"  value="<?php echo $linha['nome_funcionario']; ?>">
                                </div>
                            </div>  
                            <div class="col-2-old"><b class="title">DEPARTAMENTO:</b>
                                <div class="input-group">
                                    <input required class="input--style-2" type="text" placeholder="Departamento" name="departamento_FK"  value="<?php echo $linha['departamento_FK']; ?>">
                                </div>
                            </div>  
                            
                            <div class="col-2-old"><b class="title">EMAIL:</b>
                                <div class="input-group">
                                    <input required class="input--style-2" type="text" placeholder="Email" name="email_funcionario"  value="<?php echo $linha['email']; ?>">
                                </div>
                            </div>
                            <div class="col-2-old"><b class="title">CPF:</b>
                                <div class="input-group">
                                    <input required class="input--style-2" type="number" min='1' placeholder="CPF (somente números)" name="cpf_funcionario"  value="<?php echo $linha['cpf']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-2-old"><b class="title">RG:</b>
                                <div class="input-group">
                                    <input required class="input--style-2" type="number" min='1' placeholder="RG (somente números)" name="rg_funcionario" value="<?php echo $linha['rg']; ?>">
                                </div>
                            </div>
                            <div class="col-2-old"><b class="title">CEP:</b>
                                <div class="input-group">
                                    <input required class="input--style-2" type="number" min='1' placeholder="CEP (somente números)" name="cep_funcionario" value="<?php echo $linha['cep']; ?>">
                                </div>
                            </div>
                            <div class="col-2-old"><b class="title">ENDEREÇO:</b>
                                <div class="input-group">
                                    <input required class="input--style-2" type="text" placeholder="Endereço" name="endereco_funcionario" value="<?php echo $linha['endereco']; ?>">
                                </div>
                            </div>
                            </div>
                        <?php } ?>
                        ...
                        <div class="p-t-30">
                        <a onclick="location.href='./Edita_funcionario.php?id=<?php echo $id; ?>'"><button class="btn btn--radius btn--green" type="submit">Alterar</button></a>
                        <a onclick="location.href='./Deleta_funcionario.php?id=<?php echo $id; ?>'"><button class="btn btn--radius btn--red" type="submit">Excluir</button></a>
                        </div>
                        </form>
                    </div>
                </div>
