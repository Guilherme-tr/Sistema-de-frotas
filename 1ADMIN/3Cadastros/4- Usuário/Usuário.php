					...
					<table>
						<thead>
							<tr class="table100-head">
								<th class="column1">Usuários</th>
							</tr>
						</thead>
						<tbody>
						<?php
							$consulta4 = mysqli_query($conexao, $query4);
							while($linha = mysqli_fetch_array($consulta4)){
								echo '<tr onclick="location.href=`./ViewFicha/ViewFicha.php?usuario_id='.$linha['usuario_id'].'`"><td class="column1">'.$linha['usuario'].'</td></tr>';
							}
							?>
						</tbody>
					</table>
