                ...
                <div class="card-body">
                    ...
                    <div class="col-2-old"><b class="title">LOGIN:</b>
                            <div class="input-group">
                                <input required class="input--style-2" type="text" name="usuario" >
                            </div>
                        </div>
                        <div class="col-2-old"><b class="title">SENHA:</b>
                            <div class="input-group">
                                <input required class="input--style-2" type="password" name="senha" >
                            </div>
                        </div>
                                ...
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select required name="tipo">
                                            <option disabled="disabled" selected="selected">Tipo da conta</option>
